    ...
    return (
      <View style={{ gap: 20, marginTop: 20 }}>
        <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
          <Text category="h4" style={{ color: "#333" }}>
            Review
          </Text>
          <Ionicons name="checkmark-outline" size={32} color={"#1DB954"} />
        </View>
        <View
          style={{
  ...
  return (
    <View style={{ gap: 20, marginTop: 20 }}>
      <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
        ...
        <Ionicons name="warning-outline" size={32} color={"#1DB954"} />
      </View>
      <View
        style={{
          backgroundColor: "#F8F8F8",
      ...
      >
        ...
        <View style={{ gap: 10, alignItems: "flex-start", flex: 1 }}>
          <Text
            category="h5"
            style={{
              color: "#333",
