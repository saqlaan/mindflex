  ...
  if (reviewWords.length === 0) return (
    ...
    >
      ...
      >
        ...
        <View style={{ gap: 10, alignItems: "flex-end", justifyContent: 'flex-end', flex:1}}>
          <Text
            category="h6"
            style={{ color: "#333", flexWrap: "nowrap", marginTop: 0 }}
          >
          ...
          </Text>
          {
            newWords.length > 0 ? (
              ...
              >
                ...
                <Text style={{ color: "#fff", fontWeight: "500" }}>Review new words</Text>
                ...
                >
                  ...
                  <Text style={{ color: "#fff", fontWeight: "500" }}>Add new words</Text>
                  <Ionicons name="rocket" size={18} color={"#fff"} />
                </TouchableOpacity>
              )
          }
